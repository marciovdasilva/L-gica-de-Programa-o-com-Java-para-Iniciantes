 ...
 * Depois, receba o parâmetro referente ao faturamento real da empresa no ultimo ano. Por último, receba a média salarial do 
 * funcionário(a) para o ano anterior (não precisa fazer cálculo de média salarial, já que estamos trabalhando com um algoritmo 
 * fictício - na hora de informar esse parâmetro, invente um valor qualquer para representar essa média salarial).
 * 
 ...
 * um bônus que será igual a média salarial deles no último ano. Caso o faturamento seja menor que a meta, mas, seja maior ou igual 
 * a 80% do valor da meta, então eles receberão também 80% de sua média salarial.
 * 
...
public class Exercicio02CalculeOBonusDoFuncionarioOA {
	...
	public static void main(String[] args) {
		...
		if (funcionarioGanhamBonus) {
			...
			// Esse cálculo só precisa ser feito se a meta NÃO tiver sido batida e, por isso, ele ficou aqui.

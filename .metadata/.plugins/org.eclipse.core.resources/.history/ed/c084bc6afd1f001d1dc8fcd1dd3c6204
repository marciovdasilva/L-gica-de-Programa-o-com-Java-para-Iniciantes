 ...
 * Sua tarefa agora é pegar a classe CalcularValorTroco do capítulo 2 e utilizar a nossa biblioteca 
 * AlgaWorksConsole ao invés da classe Scanner diretamente.*/
...
//			System.out.println("Valor do troco é R$" + resultado);		
			interacao.imprimir("Valor do troco é R$" + resultado);
		}
